		...
		<div class="main">
		    ...
		    <div class="content">
		        ...
		        <form id="mainForm" method="post" action="${basePath}/login/validate">
		            <fieldset>
		                <div class="input">
		                    <input class="input_all name" name="name" value="admin" id="name" placeholder="用户名" type="text" onFocus="this.className='input_all name_now';" onBlur="this.className='input_all name'"/>
		                </div>
		                <div class="input">
		                	<input type="hidden" name="password" id="password_md5"/>
		                    <input class="input_all password" id="password" value="admin" type="password" placeholder="密码" onFocus="this.className='input_all password_now';" onBlur="this.className='input_all password'"/>
		                </div>
		                <div class="checkbox">
